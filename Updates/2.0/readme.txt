**** Keep a backup of your old files and database. Otherwise, you may lose some old data.

As it contains massive changes you need to update the full file. If you want to keep old data just import the update.sql to your database.

Changes We made :
[ADD] In admin panel advertisement limit removal added
[ADD] Max limit check added on trade request
[ADD] Kyc system added
[ADD] In advertisement fixed rate (Advertiser can set his own rate instead of system rate) also added with margin.
...
[ADD] Showing advertisement unpublished reason added
