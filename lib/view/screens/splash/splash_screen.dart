...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    print('xxxxxxxxxxx');
    Get.put(ApiClient(sharedPreferences: Get.find())) ?? print('nukk');
    Get.put(GeneralSettingRepo(apiClient: Get.find())) ?? print('nukk');
    Get.put(LocalizationController(sharedPreferences: Get.find())) ?? print('nukk');
